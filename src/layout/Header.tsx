    ...
    <header className="bg-background">
        <div className="container">
          <div className="flex justify-between items-center py-[20px] sm:justify-start gap-x-4 md:justify-between">
            <Link className="order-2 sm:order-1 md:order-1 w-[140px] lg:w-[160px]" href={'/'}><Image src={logo} alt="Logo" /></Link>
            <nav className="hidden md:flex order-2 items-center gap-x-4">
            ...
            <div className="order-1 ml-0 sm:order-2 sm:ml-auto md:ml-0 lg:flex items-center gap-x-4">
              ...
              <button className="hidden lg:flex px-3 py-2 rounded-[8px] bg-white/30 backdrop-blur-sm">Loyiha bormi?</button>
            </div>
